 ...
 *
 */
public class deleteItemDisplay implements ActionListener {
	...
	public deleteItemDisplay(JTextField box ,JFrame uItem)
	{
		 this.itemName=box;
		 this.uItem=uItem;
				   ...
				   rs=stmt.executeQuery("select * from product");
				      ...
				      int a=20,b=20;        	 
				        	...
				        	int mul=1;
				        	  ...
				        	  iname[rs.getInt(1)].addActionListener(new Distroy(rs.getInt(1),panel, iname[rs.getInt(1)]));
