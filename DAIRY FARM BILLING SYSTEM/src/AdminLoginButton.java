...
import javax.swing.JTextField;
  ...
  class AdminLoginButton implements ActionListener {
	...
	private  JTextField username,password;
	  ...
	  public AdminLoginButton(JTextField userTextField,JPasswordField passwordTextField,JLabel message,JFrame loginFrame)
	  {
		  ...
		  String uname,upass;
		   ...
		   upass=password.getText();
		    ...
		    SqlConnection call=new SqlConnection();
		     try {
				call.AuthenticationUser(2,uname,upass,message,loginFrame);
			} catch (Exception e1) {
