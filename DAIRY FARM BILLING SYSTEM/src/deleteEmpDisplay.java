 ...
 *
 */
public class deleteEmpDisplay implements ActionListener {
	...
	public deleteEmpDisplay(JTextField box ,JFrame uItem)
	{
		 this.itemName=box;
		 this.uItem=uItem;
				      ...
				      int a=20,b=20;        	 
				        	...
				        	int mul=1;
				        		 while(total!=2) 
				        		 {
						        	 ...
						        	 System.out.println("database name"+str+"  empname   "+itemName);
				        	  ...
				        	  iname[rs.getInt(1)].addActionListener(new  DistroyEmp(rs.getInt(1),panel, iname[rs.getInt(1)]));
