...
g.setColor(Color.LIGHT_GRAY);g.fillOval(xcenter - 150, ycenter - 150, 300, 300);
g.setColor(Color.yellow);g.drawString("DAIRYFARM",113,300);
g.setColor(Color.YELLOW);g.drawString("9", xcenter - 145, ycenter +0);
...
// Erase if necessary, and 

//redrawg.setColor(Color.magenta);
...
g.setColor(Color.green);g.drawLine(xcenter, ycenter - 1, xhour, yhour);
g.drawLine(xcenter - 1, ycenter, xhour, yhour);lastxs = xsecond;lastys = ysecond;
lastxm = xminute;
lastym = yminute;
lastxh = xhour;
lastyh = yhour;
